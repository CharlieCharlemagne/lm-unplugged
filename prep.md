...
- pip — Python's package manager, which usually comes with Python. Verify with pip --version.
- Git — needed to clone the project repository. Check with git --version. If you don't have it, see git-scm.com.
